...
var studentName; //variable creation with studentName)
var studentName = "Tonya"; // variable reassigneded to Tonya 

console.log ("My name is" + studentName); // Variable reassigned to Tony and we added intro of "My name is" + studentName); //
