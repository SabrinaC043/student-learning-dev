...
What command can you use to list the contents of a directory? How can you use this command to check your work? You can use it to see everything that is listed within the directory you are in. It will show you if you haven't moved over files or css sheets in order to submit it to Gitlab and Canvas. 
...
cp ~ file info here (pathway)
Mac users it is command+c and command+v 
